...
//   // Save message
//   saveMessage(national, username, email, fname, lname, address, city, county, pcode, number, message);
...
// function saveMessage(national, username, email, fname, lname, address, city, county, pcode, number, message){
